...
if "$use_ghcr"; then
    base_image_runtime=ghcr.io/tier4/pilot-auto/base-image-only-setup:runtime-cuda
    base_image_build=ghcr.io/tier4/pilot-auto/base-image-only-setup:build-cuda
else
